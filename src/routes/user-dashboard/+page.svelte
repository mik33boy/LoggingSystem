  ...
  <div class="flex-1 flex flex-col overflow-hidden items-center justify-start">
    <div class="w-full px-2 py-8">
      ...
      <div class="flex items-center justify-between bg-white p-6 rounded-2xl shadow-lg mb-8 border border-gray-200 w-full">
        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Hello, {localStorage.getItem('user') ? JSON.parse(localStorage.getItem('user') || '{}').firstName : 'User'}!</h1>
        <div class="flex items-center text-gray-600 text-base">
          <span class="inline-flex items-center px-3 py-1 rounded-full text-base font-medium bg-gray-200 text-gray-700">
            <svg class="w-5 h-5 mr-1 text-gray-500" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2h2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
            LogSystem
          </span>
          <span class="mx-2">/</span>
          <span class="inline-flex items-center px-3 py-1 rounded-full text-base font-semibold bg-gray-100 text-gray-800">Dashboard</span>
        </div>
      </div>
      <!-- Summary Cards Row -->
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6 w-full">
        <!-- Settlements Card -->
        <div class="bg-white p-6 rounded-2xl shadow flex flex-col items-center justify-center border border-gray-100">
        ...
        <!-- Pending Card -->
        <div class="bg-gray-900 p-6 rounded-2xl shadow flex flex-col items-center justify-center border border-gray-100">
          <div class="flex items-center mb-2">
        ...
        <!-- Notifications Card -->
        <div class="bg-gray-200 p-6 rounded-2xl shadow flex flex-col items-center justify-center border border-gray-100">
          <div class="flex items-center mb-2">
        ...
        <div class="bg-white p-6 rounded-2xl shadow md:col-span-2 border border-gray-100">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full text-sm">
              <thead class="bg-gradient-to-r from-blue-100 to-blue-200 text-gray-800 font-bold tracking-wider border-b border-gray-200">
                <tr class="text-left">
